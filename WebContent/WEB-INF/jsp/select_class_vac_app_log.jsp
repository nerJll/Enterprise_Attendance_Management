...
<title>My JSP 'select_class_vac_app_log.jsp' starting page</title>
...
<body>
	<div class="form-div">
		<form action="employee/selectClassVacAppLog.do" target="menuFrame"
			method="post">
			<table>
				<caption>
					<b> 班组员工假期申请日志查询</b>
				...
				<tr>
					<td colspan=2><span style="color: red; float: left;"> <c:out
								value="${select_class_vac_app_log_error }"></c:out>
					</span></td>
				</tr>
				<tr>
					<td>工号：</td>
