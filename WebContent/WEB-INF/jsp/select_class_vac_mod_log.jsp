...
<title>My JSP 'select_class_vac_mod_log.jsp' starting page</title>
...
<body>
	<div class="form-div">
		<form action="employee/selectClassVacModLog.do" target="menuFrame"
			method="post">
			<table>
				<caption>
					<b> 班组员工假期修改日志查询</b>
				...
				<tr>
					<td colspan=2><span style="color: red; float: left;"> <c:out
								value="${select_class_vac_mod_log_error }"></c:out>
					</span></td>
				</tr>
				<tr>
					<td>工号：</td>
				...
				<tr>
					...
					<td><span style="float: left;">&nbsp;&nbsp;&nbsp;<input
							...
							type="date" name="beginday" value="2017-04-24" /></span></td>
				</tr>
				<tr>
					<td>结束时间：</td>
					<td><span style="float: left;">&nbsp;&nbsp;&nbsp;<input
