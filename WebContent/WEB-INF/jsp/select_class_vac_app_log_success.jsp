...
<title>My JSP 'select_class_vac_app_success.jsp' starting page</title>
...
<body>
	<span style="color: red; float: left;"> <c:out
			value="${select_class_vac_app_log_null }"></c:out></span>
	<form action="" method="post">
		...
		<br> &nbsp;&nbsp;&nbsp;<a
			href="employee/toSelectClassVacAppLog.do" target="menuFrame">&laquo;&laquo;返回继续查询</a>
	</form>
</body>
</html>
