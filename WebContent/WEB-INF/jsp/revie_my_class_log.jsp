...
<title>My JSP 'revie_my_class_log.jsp' starting page</title>
...
<body>
	<span style="color: red; float: left;"> <c:out
			value="${revie_my_class_log_error }"></c:out></span>
	<form action="" method="post">
		...
		<table>
			...
			<c:forEach items="${revieMyClassLog }" var="attendance"
				varStatus="status">
				<tr>
					...
					<td><a
						href="employee/toCheckClassAtten.do?at_id=${attendance.at_id }">查看</a>
					</td>
				</tr>
			</c:forEach>
		</table>
