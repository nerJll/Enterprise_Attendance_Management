...
<title>My JSP 'select_class_log_log.jsp' starting page</title>
...
<body>
	<div class="form-div">
		<form action="employee/selectClassLogLog.do" target="menuFrame"
			method="post">
			<table>
				<caption>
					<b> 班组员工登陆日志查询</b>
				...
				<tr>
					<td colspan=2><span style="color: red; float: left;"> <c:out
								value="${select_class_log_log_error }"></c:out>
					</span></td>
				</tr>
				<tr>
					<td>工号：</td>
