...
<title>My JSP 'select_class_vac_can_success.jsp' starting page</title>
...
<body>
	<span style="color: red; float: left;"> <c:out
			value="${select_class_vac_can_log_null }"></c:out></span>
	<form action="" method="post">
		<table>
			...
			<c:forEach items="${classAttenCancels }" var="attendance"
				varStatus="status">
				<tr>
		...
		<br> &nbsp;&nbsp;&nbsp;<a
			href="employee/toSelectClassVacCanLog.do" target="menuFrame">&laquo;&laquo;返回继续查询</a>
	</form>
</body>
</html>
