			...
			<ul id="nav_dot">
				...
				<li>
					...
					<div class="list-item none">
						...
						<a href='employee/toSelectMyClassLog.do' target="menuFrame">班组考勤记录</a>
				...
				<li>
					...
					<div class="list-item none">
						<a href='employee/toRevieClassAtten.do' target="menuFrame">班组考勤审核</a>
					</div>
				</li>
				<li>
					<h4 class="M2">
					...
					<div class="list-item none">
						<a href='employee/toSelectClassLogLog.do' target="menuFrame">班组登陆日志查询</a>
						<a href='employee/toSelectClassVacAppLog.do' target="menuFrame">假期申请日志查询</a>
						<a href='employee/toSelectClassVacModLog.do' target="menuFrame">假期修改日志查询</a>
						<a href='employee/toSelectClassVacCanLog.do' target="menuFrame">假期删除日志查询</a>
					</div>
				</li>
			</ul>
		</div>
