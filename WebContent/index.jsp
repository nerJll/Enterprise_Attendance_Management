...
<body>
	<div class="login">
		<h1>企业考勤系统登陆</h1>
		<span style="color: red"><c:out value="${login_error }"
				escapeXml="false" /></span>
		<form action="log/login.do" method="post">
			<span class="p">用户名：</span><input type="text" name="name" required
				oninvalid="setCustomValidity('请填写用户名')"
				oninput="setCustomValidity('')" /> <span class="p">密 码：</span><input
				type="password" name="password" required
				oninvalid="setCustomValidity('请填写密码')"
				oninput="setCustomValidity('')" /> <span class="p">用户身份：</span><select
				name="user_type">
